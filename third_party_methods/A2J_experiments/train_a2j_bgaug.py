...
with open('/raid/yuliangguo/Datasets/Kinect_Depth_Human3D/labels/labels_train.json') as f:
    dict = json.load(f)
    annotations_train = dict
...
with open('/raid/yuliangguo/Datasets/Kinect_Depth_Human3D/labels/labels_test.json') as f:
    dict = json.load(f)
