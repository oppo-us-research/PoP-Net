...
from lib.datasets import datasets_kdh3d_rtpose_mpaug, data_augmentation_2d3d
...
def cli():
    ...
    parser.add_argument('--output-dir', type=str,
                        default='../predictions/rtpose_light3d_kdh3d_mpaug_v3_mpaug/')
...
if __name__ == "__main__":
    ...
    joint_names = datasets_kdh3d_rtpose_mpaug.get_keypoints()
    limb_ids = datasets_kdh3d_rtpose_mpaug.kp_connections(joint_names)
    joint2chn = np.array(range(args.num_parts))
    intrinsics = datasets_kdh3d_rtpose_mpaug.intrinsics
    ...
    val_data = datasets_kdh3d_rtpose_mpaug.KDH3D_Keypoints(
    ...
    for batch_i in range(args.num_batches):
        ...
        img, labels = val_data.generate_test_batch(args.batch_size)
        ...
        for label_img in labels:
            ...
            # humans_gt_2d_batch.append([label['2d_joints'] for label in label_img])
            # human_gt_set_2d.append([label['2d_joints'] for label in label_img])
            human_gt_set_3d.append([label['3d_joints'].tolist() for label in label_img])

        # compute output
        img = torch.from_numpy(img).view(args.batch_size, 1, args.input_size, args.input_size).cuda()
        with torch.no_grad():
        ...
        posedepth *= datasets_kdh3d_rtpose_mpaug.depth_std
        posedepth += datasets_kdh3d_rtpose_mpaug.depth_mean

        # unormalize images
        img = img.cpu().data.numpy()
        img *= datasets_kdh3d_rtpose_mpaug.depth_std
        img += datasets_kdh3d_rtpose_mpaug.depth_mean
        ...
        for b in range(args.batch_size):
            ...
            for i, human in enumerate(humans_2d):
                ...
                """
                human_3d_x = (human[:, 0] - datasets_kdh3d_rtpose_mpaug.intrinsics['cx']) * humans_depth[i] / datasets_kdh3d_rtpose_mpaug.intrinsics[
                    'fx']
                human_3d_y = (human[:, 1] - datasets_kdh3d_rtpose_mpaug.intrinsics['cy']) * humans_depth[i] / datasets_kdh3d_rtpose_mpaug.intrinsics[
                    'fy']
                ...
                """
                human_3d_x = (human[:, 0] - datasets_kdh3d_rtpose_mpaug.intrinsics['cx']) * humans_depth_raw[i] / datasets_kdh3d_rtpose_mpaug.intrinsics[
                    'fx']
                human_3d_y = (human[:, 1] - datasets_kdh3d_rtpose_mpaug.intrinsics['cy']) * humans_depth_raw[i] / datasets_kdh3d_rtpose_mpaug.intrinsics[
                    'fy']
            ...
            for i, human_gt in enumerate(humans_gt_2d_batch[b]):
                ...
                human_3d_x = (human_gt[:, 0] - datasets_kdh3d_rtpose_mpaug.intrinsics['cx']) * humans_depth_perfect_2d[i] / datasets_kdh3d_rtpose_mpaug.intrinsics[
                    'fx']
                human_3d_y = (human_gt[:, 1] - datasets_kdh3d_rtpose_mpaug.intrinsics['cy']) * humans_depth_perfect_2d[i] / datasets_kdh3d_rtpose_mpaug.intrinsics[
                    'fy']
                ...
                """
                human_3d_x = (human_gt[:, 0] - datasets_kdh3d_rtpose_mpaug.intrinsics['cx']) * humans_depth_perfect_2d_raw[i] / datasets_kdh3d_rtpose_mpaug.intrinsics[
                    'fx']
                human_3d_y = (human_gt[:, 1] - datasets_kdh3d_rtpose_mpaug.intrinsics['cy']) * humans_depth_perfect_2d_raw[i] / datasets_kdh3d_rtpose_mpaug.intrinsics[
                    'fy']
            ...
            if vis:
                ...
                visImg[visImg > datasets_kdh3d_rtpose_mpaug.depth_max] = datasets_kdh3d_rtpose_mpaug.depth_max
                visImg[visImg < 0] = 0
                visImg /= datasets_kdh3d_rtpose_mpaug.depth_max
                visImg *= 255
                ...
                visImg = draw_humans(visImg,
                                     humans_2d,
                                     limb_ids,
                                     datasets_kdh3d_rtpose_mpaug.jointColors,
                                     visibility)
                ...
                if vis_feat:
                    ...
                    pose_depth_min[pose_depth_min > datasets_kdh3d_rtpose_mpaug.depth_max] = datasets_kdh3d_rtpose_mpaug.depth_max
                    pose_depth_min[pose_depth_min < 0] = 0
                    pose_depth_min /= datasets_kdh3d_rtpose_mpaug.depth_max
                    pose_depth_min *= 255
