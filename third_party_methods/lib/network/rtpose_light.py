"""
A light version of openpose or rtpose network based on:
...
class rtpose_light(nn.Module):
    def __init__(self, num_parts=18, num_limbs=19, num_stages=2, input_dim=3):
        ...
        blocks['block1_1'] = [{'conv5_1_CPM_L1': [128, 128, 3, 1, 1]},
                              ...
                              {'conv5_5_CPM_L1': [512, 2 * num_limbs, 1, 1, 0]}]

        blocks['block1_2'] = [{'conv5_1_CPM_L2': [128, 128, 3, 1, 1]},
                              {'conv5_2_CPM_L2': [128, 128, 3, 1, 1]},
                              {'conv5_3_CPM_L2': [128, 128, 3, 1, 1]},
                              {'conv5_4_CPM_L2': [128, 512, 1, 1, 0]},
                              {'conv5_5_CPM_L2': [512, num_parts + 1, 1, 1, 0]}]

        # Stages 2
        for i in range(2, num_stages + 1):
            blocks['block%d_1' % i] = [
                {'Mconv1_stage%d_L1' % i: [128 + num_limbs * 2 + num_parts + 1, 128, 7, 1, 3]},
                {'Mconv2_stage%d_L1' % i: [128, 128, 7, 1, 3]},
                {'Mconv3_stage%d_L1' % i: [128, 128, 7, 1, 3]},
                {'Mconv4_stage%d_L1' % i: [128, 128, 7, 1, 3]},
                {'Mconv5_stage%d_L1' % i: [128, 128, 7, 1, 3]},
                {'Mconv6_stage%d_L1' % i: [128, 128, 1, 1, 0]},
                {'Mconv7_stage%d_L1' % i: [128, 2 * num_limbs, 1, 1, 0]}
            ]

            blocks['block%d_2' % i] = [
                {'Mconv1_stage%d_L2' % i: [128 + num_limbs * 2 + num_parts + 1, 128, 7, 1, 3]},
                {'Mconv2_stage%d_L2' % i: [128, 128, 7, 1, 3]},
                {'Mconv3_stage%d_L2' % i: [128, 128, 7, 1, 3]},
                {'Mconv4_stage%d_L2' % i: [128, 128, 7, 1, 3]},
                {'Mconv5_stage%d_L2' % i: [128, 128, 7, 1, 3]},
                {'Mconv6_stage%d_L2' % i: [128, 128, 1, 1, 0]},
                {'Mconv7_stage%d_L2' % i: [128, num_parts + 1, 1, 1, 0]}
            ]
...
if __name__ == "__main__":
    ...
    num_limbs = 19
    num_stages = 2
    model = rtpose_light(num_parts, num_limbs, num_stages)
    print(model)
