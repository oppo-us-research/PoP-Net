...
from lib.datasets import data_augmentation_2d3d, datasets_kdh3d
...
save_folder = './trained_model/yolo_posenet_kdh3d'
...
def train_cli(parser):
    ...
    group.add_argument('--bg-aug', default=False)
...
def train_factory(args, preprocess):
    train_data = datasets_kdh3d.KDH3D_Keypoints(
