...
from lib.datasets import data_augmentation_2d3d, datasets_itop
...
# DATA_DIR = 'DATA_DIR = /raid/yuliangguo/Datasets/ITOP'
DATA_DIR = '/media/yuliang/DATA/Datasets/ITOP'
if not os.path.exists('./trained_model'):
    os.mkdir('./trained_model')
save_folder = './trained_model/yolo_posenet_itop'
if not os.path.exists(save_folder):
    os.mkdir(save_folder)

ANNOTATIONS_TRAIN = os.path.join(DATA_DIR, 'annotations', 'ITOP_side_train_labels.json')
...
def train_factory(args, preprocess):
    train_data = datasets_itop.ItopKeypoints(
...
if __name__ == "__main__":
    ...
    intrinsics = datasets_itop.intrinsics
    ...
    preprocess = data_augmentation_2d3d.Compose([
        ...
        data_augmentation_2d3d.Hflip(swap_indices=datasets_itop.get_swap_part_indices()),
