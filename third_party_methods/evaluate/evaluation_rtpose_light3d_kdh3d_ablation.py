...
from lib.datasets import datasets_kdh3d_rtpose, data_augmentation_2d3d
...
ANNOTATIONS = os.path.join(DATA_DIR, 'labels', 'labels_test.json')
...
def cli():
    ...
    parser.add_argument('--weight', type=str,
                        default='../trained_model/rtpose_light3d_kdh3d_bgaug_v3/best_pose.pth')
    parser.add_argument('--output-dir', type=str,
                        default='../predictions/rtpose_light3d_kdh3d_bgaug_v3_bgaug/')
...
if __name__ == "__main__":
    ...
    joint_names = datasets_kdh3d_rtpose.get_keypoints()
    limb_ids = datasets_kdh3d_rtpose.kp_connections(joint_names)
    ...
    val_data = datasets_kdh3d_rtpose.KDH3D_Keypoints(
    ...
    human_gt_set_2d = []
    human_gt_set_3d = []
    for batch_i, (img, _, _, _, _, _, indices) in enumerate(val_loader):
        humans_gt_2d_batch = []
        ...
        posedepth *= datasets_kdh3d_rtpose.depth_std
        posedepth += datasets_kdh3d_rtpose.depth_mean

        # unormalize images
        img = img.cpu().data.numpy()
        img *= datasets_kdh3d_rtpose.depth_std
        img += datasets_kdh3d_rtpose.depth_mean
        ...
        for b in range(args.batch_size):
            ...
            # TODO: HARD-CODED for single person
            if len(humans_2d) > 0:
            ...
            for i, human in enumerate(humans_2d):
                ...
                """
                human_3d_x = (human[:, 0] - datasets_kdh3d_rtpose.intrinsics['cx']) * humans_depth[i] / datasets_kdh3d_rtpose.intrinsics[
                    'fx']
                human_3d_y = (human[:, 1] - datasets_kdh3d_rtpose.intrinsics['cy']) * humans_depth[i] / datasets_kdh3d_rtpose.intrinsics[
                    'fy']
                ...
                """
                human_3d_x = (human[:, 0] - datasets_kdh3d_rtpose.intrinsics['cx']) * humans_depth_raw[i] / datasets_kdh3d_rtpose.intrinsics[
                    'fx']
                human_3d_y = (human[:, 1] - datasets_kdh3d_rtpose.intrinsics['cy']) * humans_depth_raw[i] / datasets_kdh3d_rtpose.intrinsics[
                    'fy']
            ...
            for i, human_gt in enumerate(humans_gt_2d_batch[b]):
                ...
                human_3d_x = (human_gt[:, 0] - datasets_kdh3d_rtpose.intrinsics['cx']) * humans_depth_perfect_2d[i] / datasets_kdh3d_rtpose.intrinsics[
                    'fx']
                human_3d_y = (human_gt[:, 1] - datasets_kdh3d_rtpose.intrinsics['cy']) * humans_depth_perfect_2d[i] / datasets_kdh3d_rtpose.intrinsics[
                    'fy']
                ...
                """
                human_3d_x = (human_gt[:, 0] - datasets_kdh3d_rtpose.intrinsics['cx']) * humans_depth_perfect_2d_raw[i] / datasets_kdh3d_rtpose.intrinsics[
                    'fx']
                human_3d_y = (human_gt[:, 1] - datasets_kdh3d_rtpose.intrinsics['cy']) * humans_depth_perfect_2d_raw[i] / datasets_kdh3d_rtpose.intrinsics[
                    'fy']
            ...
            if vis:
                ...
                visImg[visImg > datasets_kdh3d_rtpose.depth_max] = datasets_kdh3d_rtpose.depth_max
                visImg[visImg < 0] = 0
                visImg /= datasets_kdh3d_rtpose.depth_max
                visImg *= 255
                ...
                visImg = draw_humans(visImg,
                                     humans_2d,
                                     limb_ids,
                                     datasets_kdh3d_rtpose.jointColors,
                                     visibility)
                ...
                if vis_feat:
                    ...
                    pose_depth_min[pose_depth_min > datasets_kdh3d_rtpose.depth_max] = datasets_kdh3d_rtpose.depth_max
                    pose_depth_min[pose_depth_min < 0] = 0
                    pose_depth_min /= datasets_kdh3d_rtpose.depth_max
                    pose_depth_min *= 255
