...
from lib.datasets import data_augmentation_2d3d, datasets_kdh3d_rtpose_mpaug
...
save_folder = './trained_model/rtpose_light3d_kdh3d_mpaug_v3'
...
def train_factory(args, preprocess):
    train_data = datasets_kdh3d_rtpose_mpaug.KDH3D_Keypoints(img_dir=args.image_dir,
    ...
    val_data = datasets_kdh3d_rtpose_mpaug.KDH3D_Keypoints(img_dir=args.image_dir,
