...
# ATTENTION: two additional links are added between shoulders and eyes
...
class CocoKeypoints(torch.utils.data.Dataset):
    ...
    def get_ground_truth(self, anns):
        ...
        # ATTENTION: the last dimension of the heatmap prepared for background. Good for cross-entropy loss
        # background
