...
from lib.datasets import datasets_kdh3d_rtpose_mpreal, data_augmentation_2d3d
...
ANNOTATIONS = os.path.join(DATA_DIR, 'labels_refine', 'labels_test.json')
...
def cli():
    ...
    parser.add_argument('--weight', type=str,
                        default='../trained_model/rtpose_light3d_kdh3d_mpaug_v3/best_pose.pth')
    parser.add_argument('--output-dir', type=str,
                        default='../predictions/rtpose_light3d_kdh3d_mpaug_v3_mpreal_refine/')
...
if __name__ == "__main__":
    ...
    joint_names = datasets_kdh3d_rtpose_mpreal.get_keypoints()
    limb_ids = datasets_kdh3d_rtpose_mpreal.kp_connections(joint_names)
    joint2chn = np.array(range(args.num_parts))

    cfg.defrost()
    # cfg.merge_from_file(args.cfg)
    # cfg.merge_from_list(args.opts)
    cfg.MODEL.DOWNSAMPLE = args.ht_reduction
    ...
    val_data = datasets_kdh3d_rtpose_mpreal.KDH3D_Keypoints(
    ...
    for batch_i, (img, indices) in enumerate(val_loader):
        ...
        posedepth *= datasets_kdh3d_rtpose_mpreal.depth_std
        posedepth += datasets_kdh3d_rtpose_mpreal.depth_mean

        # unormalize images
        img = img.cpu().data.numpy()
        img *= datasets_kdh3d_rtpose_mpreal.depth_std
        img += datasets_kdh3d_rtpose_mpreal.depth_mean
        ...
        for b in range(args.batch_size):
            ...
            humans_2d, visibility, conf_vec = paf_to_human_list(humans[0], humans[1])

            # if len(humans_2d) is 0:
            #    continue
            ...
            for i, human in enumerate(humans_2d):
                ...
                """
                human_3d_x = (human[:, 0] - datasets_kdh3d_rtpose_mpreal.intrinsics['cx']) * humans_depth[i] / datasets_kdh3d_rtpose_mpreal.intrinsics[
                    'fx']
                human_3d_y = (human[:, 1] - datasets_kdh3d_rtpose_mpreal.intrinsics['cy']) * humans_depth[i] / datasets_kdh3d_rtpose_mpreal.intrinsics[
                    'fy']
                ...
                """
                human_3d_x = (human[:, 0] - datasets_kdh3d_rtpose_mpreal.intrinsics['cx']) * humans_depth_raw[i] / datasets_kdh3d_rtpose_mpreal.intrinsics[
                    'fx']
                human_3d_y = (human[:, 1] - datasets_kdh3d_rtpose_mpreal.intrinsics['cy']) * humans_depth_raw[i] / datasets_kdh3d_rtpose_mpreal.intrinsics[
                    'fy']
            ...
            for i, human_gt in enumerate(humans_gt_2d_batch[b]):
                ...
                human_3d_x = (human_gt[:, 0] - datasets_kdh3d_rtpose_mpreal.intrinsics['cx']) * humans_depth_perfect_2d[i] / datasets_kdh3d_rtpose_mpreal.intrinsics[
                    'fx']
                human_3d_y = (human_gt[:, 1] - datasets_kdh3d_rtpose_mpreal.intrinsics['cy']) * humans_depth_perfect_2d[i] / datasets_kdh3d_rtpose_mpreal.intrinsics[
                    'fy']
                ...
                """
                human_3d_x = (human_gt[:, 0] - datasets_kdh3d_rtpose_mpreal.intrinsics['cx']) * humans_depth_perfect_2d_raw[i] / datasets_kdh3d_rtpose_mpreal.intrinsics[
                    'fx']
                human_3d_y = (human_gt[:, 1] - datasets_kdh3d_rtpose_mpreal.intrinsics['cy']) * humans_depth_perfect_2d_raw[i] / datasets_kdh3d_rtpose_mpreal.intrinsics[
                    'fy']
            ...
            human_pred_set_visibility.append(visibility)
            human_pred_set_part_conf.append(conf_vec)

            if vis:
                # visualization
                visImg = cv2.resize(img[b, 0, :, :], (args.w_org, args.h_org))
                visImg[visImg > datasets_kdh3d_rtpose_mpreal.depth_max] = datasets_kdh3d_rtpose_mpreal.depth_max
                visImg[visImg < 0] = 0
                visImg /= datasets_kdh3d_rtpose_mpreal.depth_max
                visImg *= 255
                ...
                visImg = draw_humans(visImg,
                                     humans_2d,
                                     limb_ids,
                                     datasets_kdh3d_rtpose_mpreal.jointColors,
                                     visibility)
                ...
                if vis_feat:
                    ...
                    pose_depth_min[pose_depth_min > datasets_kdh3d_rtpose_mpreal.depth_max] = datasets_kdh3d_rtpose_mpreal.depth_max
                    pose_depth_min[pose_depth_min < 0] = 0
                    pose_depth_min /= datasets_kdh3d_rtpose_mpreal.depth_max
                    pose_depth_min *= 255
    ...
    eval_data = {'human_pred_set_2d': human_pred_set_2d,
                 ...
                 'human_pred_set_visibility': human_pred_set_visibility,
